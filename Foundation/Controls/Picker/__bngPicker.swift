...
enum __bngPickerType {
    case date, option
}

open class __bngPicker {
    
    private static let sharedInstance = __bngPicker()
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          dataArray:Array<String> = [],
                          selectedIndex: Int? = nil,
                          type: __bngPickerType = .date) -> RPickerController? {
        
        
        if let cc = UIWindow.currentController {
            if __bngPicker.sharedInstance.isPresented == false {
                __bngPicker.sharedInstance.isPresented = true
                ...
                vc.onWillDismiss = {
                    __bngPicker.sharedInstance.isPresented = false
                }
...
class RPickerController: UIViewController {
    ...
    var pickerType: __bngPickerType = .date
